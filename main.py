...
class Zefoy:
    def __init__(self):
        ...
        url1=input("\033[1;33mLink Video Tiktok: ")
        self.url=url1
    ...
    def get_table(self, i = 1):
        ...
        for service in self.services:
            ...
            i += 1
        table.title = f"{Fore.YELLOW} Update Bye D ONE: {len([x for x in self.services_status if self.services_status[x]])}{Fore.RESET}"
        print(table)
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zefoy:
                    t-=1
                    print('\033[31m[Cyraxmod]=>Please what: \033[1;32m{0}\033[31m '.format(t)+'second\033[1;32m',end='\r')
                    time.sleep(1)
                continue
